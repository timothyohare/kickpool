// AUTO-GENERATED from FIFA World Cup 26 Regulations, Annex C (do not edit by hand).
...
//
// Vendored verbatim from the sibling FifaWorldCupMonteCarloSim project
// (src/engine/annex-c.ts). Static FIFA-regulation data — copied (not imported) so kickpool
// has no build-time dependency on a sibling repo. Re-copy from there if the source changes.
...
export const THIRD_CANDIDATES: Readonly<Record<string, string>> = {"A":"CEFHI","B":"EFGIJ","D":"BEFIJ","E":"ABCDF","G":"AEHIJ","I":"CDFGH","K":"DEIJL","L":"EHIJK"};
